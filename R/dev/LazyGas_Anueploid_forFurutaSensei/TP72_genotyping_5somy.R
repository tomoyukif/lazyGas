...
setwd("/Users/okapi/Desktop/GBSCreenR_V2/genotype_for_anueploidy/TP72/5somy/")
length(snp.position)

colnames(dosage) <- paste0(snp.chromosome, "_", snp.position)

write.csv(dosage, "TP72genotype_ploidy5.csv")



pdf("TP72_5somyGenotype.pdf")
