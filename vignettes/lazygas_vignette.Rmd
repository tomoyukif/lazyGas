---
title: "Genetic Association Study with lazyGa"
author: 
...
lg <- buildLazyGas(gds_fn = sample_gds, load_filter = TRUE, overwrite = FALSE)
```
...
pheno <- read.csv(file = sample_pheno)
```
...
```{r}
recalcAssoc(object = lg, signif = 0.05, threshold = 0.8, n_threads = 10)
...
gff_fn <- "~/hdd3/genomeData/rice/cultivar_sativa/nb_combined/version_2023/gff/nb_combined_all_annotated.gff"

# SNPEff output VCF file
snpeff_fn <- "~/hdd5/ngsData/wgs/shufflingParents/snpeff/founder_wgs_on_bv_genome_snpeff.vcf.gz"
...
source("~/hdd3/genomeData/util_scripts/util08_orgAnnotation.R")
